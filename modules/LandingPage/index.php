  ...
  <!-- Contenido Principal -->
   <div class="main-content">
    <h2 class="mb-4 d-flex justify-content-between align-items-center">
      Panel de Control
      <a href="/extrenos" class="btn btn-danger btn-sm btn-add fs-5"><i class="bi bi-plus-circle"></i> Agregar Seguro</a>
    </h2>
      ...
      <table class="table table-hover">
        ...
        <tbody>
          <tr>
            ...
            <td>2025-07-25</td>
            <td><span class="badge badge-pagado bg-success">Pagado</span></td>
          </tr>
          <tr>
            <td>Ana Gómez</td>
