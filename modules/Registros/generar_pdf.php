...
<div class='info'>
    ...
    <p><strong>Poliza:</strong> " . htmlspecialchars($seguro["poliza"]) . "</p>
    <p><strong>Cedula:</strong> " . htmlspecialchars($seguro["cedula"]) . "</p>
    <p><strong>Telefono:</strong> " . htmlspecialchars($seguro["telefono"]) . "</p>
    <p><strong>Direccion:</strong> " . htmlspecialchars($seguro["direccion"]) . "</p>
    <h2>Informacion de Vehiculo</h2>
    <p><strong>Vehículo:</strong> " . htmlspecialchars($seguro["tipo_vehiculo"]) . " - " . htmlspecialchars($seguro["marca"]) . "</p>
     <p><strong>Servicio:</strong> " . htmlspecialchars($seguro["servicio"]) . "</p>
     <p><strong>Año:</strong> " . htmlspecialchars($seguro["ano"]) . "</p>
     <p><strong>Modelo:</strong> " . htmlspecialchars($seguro["modelo"]) . "</p>
    <p><strong>Chasis:</strong> " . htmlspecialchars($seguro["chasisVehiculo"]) . "</p>
    <p><strong>Placa:</strong> " . htmlspecialchars($seguro["placa"]) . "</p>
    <p><strong>Color:</strong> " . htmlspecialchars($seguro["color"]) . "</p>
    <p><strong>Toneladas Cilindrada:</strong> " . htmlspecialchars($seguro["tonCilVehiculo"]) . "</p>
    <p><strong>Pasajeros:</strong> " . htmlspecialchars($seguro["pasajerosVehiculo"]) . "</p>
    <p><strong>Observaciones:</strong> " . htmlspecialchars($seguro["observacionesVehiculo"]) . "</p>
    
    <h2>Detalles del Seguro</h2>
    <p><strong>Tipo de Seguro:</strong> " . htmlspecialchars($seguro["tipoSeguro"]) . "</p>
    <p><strong>Descripción:</strong> " . htmlspecialchars($seguro["tipo_pago"]) . "</p>
