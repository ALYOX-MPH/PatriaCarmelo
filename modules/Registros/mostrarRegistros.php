...
<body>
    ...
    <div class="card p-4 mb-4 ">
        ...
        <p class="fs-4"><strong>Nombre:</strong> <?= htmlspecialchars($cliente['nombre']) ?></p>
        <p class="fs-4"> <strong>Poliza:</strong> <?= $cliente['poliza'] ?></p>
        <p class="fs-4"><strong>Cédula:</strong> <?= $cliente['cedula'] ?></p>
        <p class="fs-4"><strong>Teléfono:</strong> <?= $cliente['telefono'] ?></p>
        <p class="fs-4"><strong>Dirección:</strong> <?= $cliente['direccion'] ?></p>
    </div>

    <div class="card p-4 mb-4 ">
        <h1>Información del Vehículo</h1>
        <p class="fs-4"><strong>Tipo:</strong> <?= $cliente['tipo_vehiculo'] ?></p>
        <p class="fs-4"><strong>Servicio:</strong> <?= $cliente['servicio'] ?></p>
        <p class="fs-4"><strong>Marca:</strong> <?= $cliente['marca'] ?></p>
        <p class="fs-4"><strong>Año:</strong> <?= $cliente['ano'] ?></p>
        <p class="fs-4"><strong>Modelo:</strong> <?= $cliente['modelo'] ?></p>
        <p class="fs-4"><strong>Chasis:</strong> <?= $cliente['chasisVehiculo'] ?></p>
        <p class="fs-4"><strong>Placa:</strong> <?= $cliente['placa'] ?></p>
        <p class="fs-4"><strong>Color:</strong> <?= $cliente['color'] ?></p>
        <p class="fs-4"><strong>Ton/Cil:</strong> <?= $cliente['tonCilVehiculo'] ?></p>
        <p class="fs-4"><strong>Pasajeros:</strong> <?= $cliente['pasajerosVehiculo'] ?></p>
        <p class="fs-4"><strong>Observaciones:</strong> <?= $cliente['observacionesVehiculo'] ?></p>
    </div>
